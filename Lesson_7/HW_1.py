...
list_alp = set('аеиоёюя')
vini_word = input().split()
vini_word_num = [word.count(char) for word in vini_word for char in word if char in list_alp]


if len(set(vini_word_num)) == 1:
     print("Парам пам-пам")
else:
     print("Пам парам")
