...
i = int(input("Введите номер вагона поезда: "))
j = int(input("Введите номер вагона поезда, в который сел витя: "))
if i == j:
    print("Для решение требуется дополнительная информация")
else:
    number = i + j - 1
print(number)
